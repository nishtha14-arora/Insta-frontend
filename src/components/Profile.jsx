...
class Profile extends Component{
    ...
    async componentDidMount(){
      ...
      let followerObj =await axios.get("http://localhost:3000/user/follower/714068e1-423c-4d35-83b9-8f7a95313820")
      console.log(followerObj);
      let following = followingObj.data.data;
      let followers = followerObj.data.data;


      let postData=await axios.get("http://localhost:3000/post/714068e1-423c-4d35-83b9-8f7a95313820");
